...
const SocialMediaQr = () => {
  return (
   ...
   <div className={style.businessCard}>
        ...
        <a  href={"https://levantisk-b1.s3.eu-north-1.amazonaws.com/ResumeENG%2B0.06.pdf"}  download target='_blank' className={style.cardLinks} alt='download resume'> <FaDownload/><h1> Download CV</h1></a>
